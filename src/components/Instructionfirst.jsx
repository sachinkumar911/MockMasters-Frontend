        ...
        <div class="bg-gray-50 p-6 h-[90vh] rounded-md overflow-y-scroll w-3/4">
          ...
          <ul class="list-disc ml-6">
            ...
            <li>
              ...
              symbols:
              <br />
              <span>1</span> You have not visited the question.
              <br />
              <span>3</span> You have not answered the question.
              <br />
              <span>4</span> You have answered the question.
              <br />
              <span>6</span> You have NOT answered the question, but have marked
              the question for review.
              <br />
              <span>9</span> You have answered the question, but marked it for
              review.
              <br />
              <br />
            </li>
          ...
          <ul class="list-disc ml-6">
            <li>
              ...
              <ul class="list-disc ml-6">
                ...
                <li>
                  Click on Mark for Review &amp; Next to save your answer for
