            ...
            >
              <div className=" mx-auto px-4 ">
                ...
                <div className="flex justify-center my-2">
                  <Link to="/test/test-analysis" className="w-full">
                    <button
                      type="button"
                      className="w-full flex items-center justify-center px-5 py-2 text-sm text-gray-700 font-medium hover:bg-[#4762fe] hover:text-white transition-colors duration-200 bg-white border rounded-lg gap-x-2"
                    >
