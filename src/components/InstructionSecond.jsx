      ...
      <div class=" flex flex-col h-[32vh] bg-white fixed bottom-0 left-0  w-3/4  border-blue-400 border-t-2 border-r-2 px-4 py-2">
        ...
        <div class="flex flex-row mb-2">
          <input
            type="checkbox"
            id="myCheckbox"
            class="h-4 w-4 text-indigo-600 border-gray-300 rounded mr-2 mt-1"
          ></input>
          <p class="pt-0">
            {" "}
        ...
        <div class="flex justify-between py-8">
          <Link to="/Instructionfirst">
            ...
            <button
              type="button"
              class="text-green-700 hover:text-white border border-green-700 hover:bg-green-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
            >
              Previous
            </button>
          </Link>
          ...
          <button
            type="button"
            class=" px-8 min-w-0 text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-700  font-medium rounded-lg text-sm  py-2.5 text-center me-2 mb-2  "
          >
            Start Exam
          </button>
        </div>
